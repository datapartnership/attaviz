...
For choropleth maps, install the optional GeoPandas support:

```bash
uv add "attaviz[maps] @ git+https://github.com/datapartnership/attaviz.git"
# or
...
Dependencies (`altair`, `pandas`, `pyarrow`, `vegafusion`, `vl-convert-python`) install
automatically.
